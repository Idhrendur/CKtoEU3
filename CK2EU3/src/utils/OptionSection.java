...
public abstract class OptionSection {
	...
	public static boolean isIN() {
		return "IN".equals(__option);
	}
	
	public static boolean isNA() {
		return "NA".equals(__option);
	}
	
	public static boolean isVanilla() {
		return "EU3".equals(__option);
	}
	
	public static short getMinBirth() {
		return isIN() ? (short) 1374 : (short) 1428;
	}
	
	public static short getStartYear() {
		short startYear = isIN() ? (short) 1399 : (short) 1453; 
		return startYear;
	}

	public static short getStartMonth() {
		return isIN() ? (short) 10 : (short) 5;
	}

	public static short getStartDay() {
		return isIN() ? (short) 14 : (short) 30;
	}
	
	public static String getStartDate() {
		return isIN() ? "1399.10.14" : "1453.5.30";
	}	
